...
"ctrl-^ goes to the last opened file (or use :e# or :e#n)

"snippets
"to make a snippet, do nnoremap whatever :-1read path/to/file<CR>

"registers: + (or *?) = system clipboard 
"navigating help: :helpgrep, can use (mode)_characters to get character maps
"in certain mode
